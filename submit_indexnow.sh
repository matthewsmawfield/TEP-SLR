#!/bin/bash
# =============================================================================
# IndexNow Submission Script for TEP-GL
# =============================================================================
...
KEY_LOCATION="https://matthewsmawfield.github.io/TEP-GL/${KEY}.txt"

# URLs to index
URL_TO_INDEX="https://matthewsmawfield.github.io/TEP-GL/"
PDF_TO_INDEX="https://matthewsmawfield.github.io/TEP-GL/public/docs/Smawfield_2025_TemporalSpatialCoupling_GL_v0.3_Tortola.pdf"
...
echo "=============================================="
echo "IndexNow Submission for TEP-GL"
echo "=============================================="
echo ""
echo "Host: $HOST"
