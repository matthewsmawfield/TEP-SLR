...
def load_citation_metadata():
    ...
    if not citation_file.exists():
        ...
        return {'version': 'v0.2', 'codename': 'Mombasa', 'title': 'TEP-SLR'}
    ...
    try:
        ...
        if match:
            ...
            codename = match.group(2) or 'Mombasa'
        else:
...
def copy_pdf_to_docs(source_pdf: Path, docs_dir: Path):
    ...
    # Primary PDF name (matches markdown filename format)
    target_name = f"8-TEP-SLR-v{metadata['version']}-{metadata['codename']}.pdf"
